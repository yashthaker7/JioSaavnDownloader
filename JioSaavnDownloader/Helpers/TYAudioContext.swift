...
final class TYAudioContext {
    ...
    public static func load(fromAudioURL audioURL: URL, completionHandler: @escaping (_ audioContext: TYAudioContext?) -> ()) {
        ...
        asset.loadValuesAsynchronously(forKeys: ["duration"]) {
            ...
            case .loaded:
                ...
                let audioContext = TYAudioContext(audioURL: audioURL, totalSamples: totalSamples, asset: asset, assetTrack: assetTrack)
...
func render(audioContext: TYAudioContext?, targetSamples: Int = 100) -> [Float] {
